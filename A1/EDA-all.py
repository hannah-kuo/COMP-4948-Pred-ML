...
df['Sepsis_Positive'].value_counts().plot(kind='pie', autopct='%1.1f%%', labels=['No Sepsis', 'Sepsis'],
                                          colors=['green', 'red'])
...
# Scatter plot of PL vs M11 colored by Sepsis_Positive
plt.figure(figsize=(8, 6))
sns.scatterplot(data=df, x='PRG', y='Age', hue='Sepsis_Positive', palette=['green', 'red'])
