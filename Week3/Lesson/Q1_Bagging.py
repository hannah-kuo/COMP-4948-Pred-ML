...
for clf in classifierArray:
    ...
    # bagging_clf = BaggingClassifier(clf, max_samples=0.4, max_features=11, n_estimators=100)
    bagging_clf = BaggingClassifier(clf, max_samples=0.4, max_features=3, n_estimators=100)
