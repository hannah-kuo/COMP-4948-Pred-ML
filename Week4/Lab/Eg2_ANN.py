"""
Example 2: Neural Network Applied

This example shows how to use the network from Example 1 to build a model which predicts whether
a student will be accepted to a college or University where they apply
"""
