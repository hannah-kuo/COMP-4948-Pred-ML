""" Example 5: Enabling Early Stopping and Saving the Best Model """
...
PATH = "C:/PredML/small_cats_and_dogs/"
...
# --------------------------------------------------------------
# Code to convert to 3D Array
# Performs the transformation to a matrix
# --------------------------------------------------------------
...
# --------------------------------------------------------------
# Code to show loss and accuracy
# --------------------------------------------------------------
